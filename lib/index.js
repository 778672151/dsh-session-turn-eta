...
function etaCore(input) {
	...
	if (expectedTurnSteps === void 0 || expectedTurnSteps < 1) return base;
	...
	const predictedTotalMs = input.previousTotalMs === void 0 ? rawTotalMs : Math.min(rawTotalMs, input.previousTotalMs);
